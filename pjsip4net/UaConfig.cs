...
namespace pjsip4net
{
    public class UaConfig : Initializable
    {
        ...
        private readonly List<VoIPTransport> _transports = new List<VoIPTransport>();
        ...
        internal UaConfig()
        {
            SipUserAgent.ApiFactory.GetBasicApi().pjsua_config_default(_config);
        ...
        public IList<VoIPTransport> Transports
        {
        ...
        public void RegisterTransport(VoIPTransport transport)
        {
            GuardNotInitializing();
