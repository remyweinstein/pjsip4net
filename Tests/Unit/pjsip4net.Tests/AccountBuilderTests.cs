...
namespace pjsip4net.Tests
{
    ...
    public class AccountBuilderTests
    {
        ...
        public void Register_WithCorrectData_CreatesCorrectAccount()
        {
            ...
            Account result = new WithAccountBuilderExpression(new AccountBuilderFake()).With("1000", "1234").At("74.208.167.44")
                .Through("5081").Over(VoIPTransport.CreateTLSTransport()).Go(true, true);
        ...
        {
            Account result = new WithAccountBuilderExpression(new AccountBuilderFake()).With("1000", "1234").At("")
                .Through("5081").Over(VoIPTransport.CreateTLSTransport()).Go(true, true);
        }
    }
}